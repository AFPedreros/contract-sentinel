    ...
    return (
        ...
        >
            <input
                ...
                class='block w-full rounded-lg border border-gray-600 bg-gray-700 p-2.5 text-sm  text-white placeholder-gray-400 focus:border-indigo-600 focus:ring-indigo-600'
            />
            <input
                required={true}
